<?php
    ...
    if($con)
    {
        ...
        $query1="select * from contactnumbers where email='$email';";
        $result1=mysqli_query($con,$query1);
        $num=0;
        $num=mysqli_num_rows($result1);
        if($num==0)
        {
            $query3="insert into contactnumbers (email,name,contact1,contact2,contact3,contact4,contact5) values ('$email','$name','$contact1','$contact2','$contact3','$contact4','$contact5');";
        ...
        if($num==1)
        {
            $query2="update contactnumbers set name='$name',contact1='$contact1',contact2='$contact2',contact3='$contact3',contact4='$contact4',contact5='$contact5' where email='$email';";
